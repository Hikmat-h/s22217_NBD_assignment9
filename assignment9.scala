object assignment9 {
  def main(args: Array[String]): Unit = {
    ...
    println("Task 1")
    val task1: Task1[String] = new Task1("Some")
    ...
    val task3yes: Task3[Yes[String]] = new Task3[Yes[String]](new Yes("Some"))
    ...
    val task4yes: Task4[Yes[String]] = new Task4[Yes[String]](new Yes("Some"))
...
class Task4[A](c: A) {
  ...
  def getOrElse[B]: B =
  {
    if (_c.isInstanceOf[No])
      return "NO class with NO content".asInstanceOf[B]
